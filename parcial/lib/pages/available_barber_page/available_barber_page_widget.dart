...
import 'available_barber_page_model.dart';
export 'available_barber_page_model.dart';

class AvailableBarberPageWidget extends StatefulWidget {
  const AvailableBarberPageWidget({Key? key}) : super(key: key);

  @override
  _AvailableBarberPageWidgetState createState() =>
      _AvailableBarberPageWidgetState();
}

class _AvailableBarberPageWidgetState extends State<AvailableBarberPageWidget> {
  late AvailableBarberPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AvailableBarberPageModel());
